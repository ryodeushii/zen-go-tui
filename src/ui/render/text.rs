...
pub(crate) fn render_hotkeys_popup_text() -> Text<'static> {
    Text::from(vec![
        ...
        Line::from("  F1 Mixer   F2 AuraVerb   F3 Surround (when available)"),
        Line::from("  Tab/Shift+Tab focus   Arrows select/adjust"),
        Line::from("  Enter confirm popup selection"),
        Line::from(""),
        Line::from("AuraVerb Page (when available)"),
        Line::from("  Arrows ±1   PgUp/PgDn ±10   Home/End 0/100"),
        Line::from("  Space/Enter toggle Enabled when focused"),
        Line::from(""),
        ...
        Line::from(""),
        Line::from("Device"),
        Line::from("  click device name to select another device"),
