...
mod tests {
    ...
    use crate::types::{
        OFFSET_DSP_CLUSTER_END, OFFSET_DSP_CLUSTER_START, OFFSET_METER_LANES_START,
        ...
        OFFSET_PREAMP1_METER, OFFSET_PREAMP2_METER, OFFSET_SHARED_SHADOW_0, OFFSET_SHARED_SHADOW_1,
