...
- **`0x04/*` and `0x0b/03`**: these are still not trusted for startup level/pan/mute, but `0x04/01` and `0x04/02` are now grounded enough to seed the visible linked-pair topology on `CH3..CH16`
